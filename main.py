...
class App:
    ...
    def draw(self):
        ...
        px.text(0, 0, f"X={self.camera_position.x}", 2)
        px.text(0, 6, f"Y={self.camera_position.y}", 2)
        px.text(0, 12, f"Z={self.camera_position.z}", 2)
